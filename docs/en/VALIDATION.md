...
```bash
python3 _nonreg.py --jobs 8      # expected on the full base: 689/689
```
...
```bash
python3 tests/suite_conversation.py     # expected: 25/25 gates green
```
