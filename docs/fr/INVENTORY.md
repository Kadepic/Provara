...
| `tronc` | TRONC DE COMPRÉHENSION — Phase 1 (SPEC_TRONC_COMPREHENSION §7-§10) : acte(signal, contexte) → Faisceau — carte fermée des 11 actes de parole, candidats parallèles (G2), repli honnête intent-aware (G6), attunement (2026-07-07). | acte, repli, attunement, class Candidat, class Faisceau |
