#!/usr/bin/env bash
# Provara — installation / vérification. Provara ne dépend QUE de Python 3.10+ (zéro bibliothèque tierce).
set -e
cd "$(dirname "$0")"
echo "──────────────  Provara : installation  ──────────────"
...
echo "✓ Python $PYV"
echo "✓ Aucune dépendance tierce à installer (Provara = bibliothèque standard uniquement)"
