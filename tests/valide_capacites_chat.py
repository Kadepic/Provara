...
# TRADUCTION : rien traduit = refus honnête (« merci » rendu comme sa « traduction » allemande, vécu).
r = R._cap_traduction("comment dit-on merci en allemand ?")
check(r is not None and "je préfère ne rien traduire" in r, "tout inconnu -> refus honnête, jamais l'écho")
r = R._cap_traduction("traduis bonjour en anglais")
check(r is not None and r.startswith("Hello"), "traduction réelle intacte")
