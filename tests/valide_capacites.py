...
check(n_ok == 299, f"299 sujets au registre (vu {n_ok})")  # 2026-07-08 : +18 preuves façade ia.py (lots 1-13, excellence atomique)
...
check(len(C.sujets_couverts()) == 299, "sujets_couverts() = 299")
