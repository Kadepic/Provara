...
check(n_ok == 302, f"302 sujets au registre (vu {n_ok})")  # 2026-07-08 : +21 preuves façade ia.py (lots 1-16, excellence atomique)
...
check(len(C.sujets_couverts()) == 302, "sujets_couverts() = 302")
