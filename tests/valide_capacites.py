...
check(n_ok == 300, f"300 sujets au registre (vu {n_ok})")  # 2026-07-08 : +19 preuves façade ia.py (lots 1-14) — cap des 300 preuves
...
check(len(C.sujets_couverts()) == 300, "sujets_couverts() = 300")
