...
check(n_ok == 295, f"295 sujets au registre (vu {n_ok})")  # 2026-07-08 : +14 preuves façade ia.py (lots 1-9, excellence atomique)
...
check(len(C.sujets_couverts()) == 295, "sujets_couverts() = 295")
