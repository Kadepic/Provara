...
check(n_ok == 297, f"297 sujets au registre (vu {n_ok})")  # 2026-07-08 : +16 preuves façade ia.py (lots 1-11, excellence atomique)
...
check(len(C.sujets_couverts()) == 297, "sujets_couverts() = 297")
