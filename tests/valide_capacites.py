...
check(n_ok == 301, f"301 sujets au registre (vu {n_ok})")  # 2026-07-08 : +20 preuves façade ia.py (lots 1-15, excellence atomique)
...
check(len(C.sujets_couverts()) == 301, "sujets_couverts() = 301")
