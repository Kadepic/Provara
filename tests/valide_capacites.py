...
check(n_ok == 292, f"292 sujets au registre (vu {n_ok})")  # 2026-07-08 : +11 preuves façade ia.py (lots 1-6, excellence atomique)
...
check(len(C.sujets_couverts()) == 292, "sujets_couverts() = 292")
