...
check(n_ok == 293, f"293 sujets au registre (vu {n_ok})")  # 2026-07-08 : +12 preuves façade ia.py (lots 1-7, excellence atomique)
...
check(len(C.sujets_couverts()) == 293, "sujets_couverts() = 293")
