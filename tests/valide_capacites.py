...
check(n_ok == 291, f"291 sujets au registre (vu {n_ok})")  # 2026-07-08 : +10 preuves façade ia.py (lots 1-5, excellence atomique)
...
check(len(C.sujets_couverts()) == 291, "sujets_couverts() = 291")
