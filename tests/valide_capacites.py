...
check(n_ok == 298, f"298 sujets au registre (vu {n_ok})")  # 2026-07-08 : +17 preuves façade ia.py (lots 1-12, excellence atomique)
...
check(len(C.sujets_couverts()) == 298, "sujets_couverts() = 298")
