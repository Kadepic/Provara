...
check(n_ok == 294, f"294 sujets au registre (vu {n_ok})")  # 2026-07-08 : +13 preuves façade ia.py (lots 1-8, excellence atomique)
...
check(len(C.sujets_couverts()) == 294, "sujets_couverts() = 294")
