...
check(n_ok == 296, f"296 sujets au registre (vu {n_ok})")  # 2026-07-08 : +15 preuves façade ia.py (lots 1-10, excellence atomique)
...
check(len(C.sujets_couverts()) == 296, "sujets_couverts() = 296")
